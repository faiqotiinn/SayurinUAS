...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  private FragmentFirstBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton addFAB, @NonNull Button backButton,
      @NonNull RecyclerView dataRecyclerView, @NonNull TextView emptytextView,
      @NonNull ImageView illustrationimageView) {
    this.rootView = rootView;
    this.addFAB = addFAB;
    this.backButton = backButton;
    this.dataRecyclerView = dataRecyclerView;
    this.emptytextView = emptytextView;
    this.illustrationimageView = illustrationimageView;
  }
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.illustrationimageView;
      ImageView illustrationimageView = ViewBindings.findChildViewById(rootView, id);
      if (illustrationimageView == null) {
        break missingId;
      }

      return new FragmentFirstBinding((ConstraintLayout) rootView, addFAB, backButton,
          dataRecyclerView, emptytextView, illustrationimageView);
    }
